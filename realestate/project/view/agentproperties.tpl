          ...
          <div class="row">
                 ...
                 <div class="col-lg-4 col-md-4 col-ms-12 col-12">
                    <ul class="nav navlogin">
                        <li ><a class="href"><i class="fa fa-user mr-3"></i>Login</a></li>
                        <li>|</li>
                        <li><a class="href"><i class="fa fa-plus mr-3"></i>SELL</a></li>
                    </ul>
                 </div>
          </div>
    </div>
                        ...
                        <table class="table table-hover table-borderless table-responsive" id="table-id">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <th class="text-center font-weight-light">Agent Name 1</th>
                                     <th class="text-center font-weight-light"> TVM</th>
                                     <th class="text-center font-weight-light">Panchayath 1</th>
                                    <th class="text-center font-weight-light">Property title1</th>
                                    <td class="text-center">      
                                            <a href="img/chairs-640.jpg" data-source="img/chairs-640.jpg" class="with-caption image-link" title="The caption">
                                ...
                                <tr>
                                    ...
                                    <th class="text-center font-weight-light">Agent Name3</th>
                                     <th class="text-center font-weight-light"> TVM</th>
                                     <th class="text-center font-weight-light">Panchayath 1</th>
                                    <th class="text-center font-weight-light">Property title1</th>
                                    <td class="text-center">      
