               ...
               <div class="row">
                     ...
                     <div class="col-lg-3 col-md-3 col-sm-12 col-12">
                            <div class="box text-center">
                                ...
                                <h5><a href="listAgents.php"  class="btn btn-light btn-dashboard"><span>List All Agents in {$district}&nbsp;[{$panchayath}]</span></a></h5>
                            </div>
                     </div>
                     ...
                     <div class="col-lg-3 col-md-3 col-sm-12 col-12">
                            <div class="box text-center">
                               <h5><a href="pendingPropertiesForExecutive.php"  class="btn btn-light btn-dashboard">List All Properties in {$district}&nbsp;[{$panchayath}]</a></h5>
                           </div>
                    </div>
