                        ...
                        <table class="table table-hover table-borderless table-responsive" id="table-id">
							...
							{foreach from=$properties item=property}
                                <tr>
									...
									<th class="text-center font-weight-light"><a href="deleteActiveProperty.php?key={$property.property_key}" onclick="return confirm('Are you sure to Delete This Property ?')" style="color:red;">Delete</a></th>
                                </tr>
                            {/foreach}    
                             </tbody>
							 {else}
