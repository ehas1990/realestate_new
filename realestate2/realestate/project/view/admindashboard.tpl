               ...
               <div class="row">
					 ...
					 <div class="col-lg-3 col-md-3 col-sm-12 col-12">
                            <div class="box text-center">
                                ...
                                <h5><a href="createExecutive.php"  class="btn btn-light btn-dashboard"><span>Create Executive Account</span></a></h5>
                            </div>
                     </div>
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-12 col-12">
                            <div class="box text-center">
                                ...
                                <h5><a href="districtSettings.php"  class="btn btn-light btn-dashboard">District Setting</a></h5> 
                           </div>
                    </div>
                    <div class="col-lg-3 col-md-3 col-sm-12 col-12">
                         <div>
                            <div class="box text-center">
                                <h5><a href="panchayathSettings.php"  class="btn btn-light btn-dashboard">Panchayath Setting</a></h5> 
