<?php
/* Smarty version 3.1.36, created on 2022-12-22 05:42:19
  from '/home/u121402034/domains/a2zserver.in/public_html/REAL_ESTATE/project/view/districtSettings.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.36',
  'unifunc' => 'content_63a3ee3b776158_66735034',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '2be56cf57c268634d3baf40cf3620ba798ac7464' => 
    array (
      0 => '/home/u121402034/domains/a2zserver.in/public_html/REAL_ESTATE/project/view/districtSettings.tpl',
      1 => 1670311600,
      2 => 'file',
    ),
  ),
...
function content_63a3ee3b776158_66735034 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html lang="en">
<head>
                    ...
                    <div class="card">
						...
						<?php }?>		
                            ...
                            <form action="" method="post">
									<input type="hidden" name="act" value="addDistrict">
									
									<div class="mt-4"></div>
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                                            <label class="form-label  float-left">District Name</label>
                                        </div>
                                        <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                                            <div class="float_right">
                                                <input type="submit" name="submit" value="Add District" class="btn btn-danger btn-sm sm-btn">
                                            </div>
...
?>
									...
									<tr>
										<td class="text-center"><?php echo $_smarty_tpl->tpl_vars['d']->value['district_name'];?>
</a></td>
										<td class="text-center"><a href="editDistrict.php?key=<?php echo $_smarty_tpl->tpl_vars['d']->value['district_key'];?>
">Edit </a></td>
										<?php if ($_smarty_tpl->tpl_vars['d']->value['popular'] == 0) {?>
										<td class="text-center"><a href="markPopularDistrict.php?key=<?php echo $_smarty_tpl->tpl_vars['d']->value['district_key'];?>
">Mark us Popular </a></td>
										<?php } elseif ($_smarty_tpl->tpl_vars['d']->value['popular'] == 1) {?>
										<td class="text-center"><a href="markNormalDistrict.php?key=<?php echo $_smarty_tpl->tpl_vars['d']->value['district_key'];?>
">Mark us Normal </a></td>
										<?php }?>
									</tr>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>					 
							...
							<?php } else { ?>
								<div class="emptyBox">
									There is no districts added yet.
								</div>
							<?php }?>
						</div>
                    </div>
