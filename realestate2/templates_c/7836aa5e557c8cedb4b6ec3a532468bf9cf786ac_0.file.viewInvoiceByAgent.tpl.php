<?php
/* Smarty version 3.1.36, created on 2022-12-21 10:04:15
  from '/home/u121402034/domains/a2zserver.in/public_html/REAL_ESTATE/project/view/viewInvoiceByAgent.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.36',
  'unifunc' => 'content_63a2da1f0c4d61_04270045',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '7836aa5e557c8cedb4b6ec3a532468bf9cf786ac' => 
    array (
      0 => '/home/u121402034/domains/a2zserver.in/public_html/REAL_ESTATE/project/view/viewInvoiceByAgent.tpl',
      1 => 1671617051,
      2 => 'file',
    ),
  ),
...
function content_63a2da1f0c4d61_04270045 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html lang="en">
<head>
					...
					<div class="card_1">
					     <div class="row">
						     <div class="col-lg-9 col-md-9 col-sm-9 col-9" style="color:#000000;font-weight:bold;">
							       Invoice Details  : <?php echo $_smarty_tpl->tpl_vars['invoiceDetails']->value[0]['public_key'];?>
						...
						<div class="col-12 col-lg-12 col-md-12 col-sm-12">
                            ...
                            <form action="" method="post" enctype="multipart/form-data">
									...
									<?php if ($_smarty_tpl->tpl_vars['invoiceDetails']->value[0]['agent_name']) {?>
									<div class="row">
											...
											<div class="col-lg-7 col-md-7 col-sm-7 col-7">
												   <h6 class="text-left"><small  > <?php echo $_smarty_tpl->tpl_vars['invoiceDetails']->value[0]['agent_name'];?>
</small></h6>
											</div>
								    </div>
									<?php }?>
									<div class="mt-2"></div>
								   <?php if ($_smarty_tpl->tpl_vars['invoiceDetails']->value[0]['contact_number']) {?>	
                                   <div class="row">
											...
											<div class="col-lg-7 col-md-7 col-sm-7 col-7">
												   <h6 class="text-left"><small><?php echo $_smarty_tpl->tpl_vars['invoiceDetails']->value[0]['contact_number'];?>
</small></h6>
											</div>
								    </div>
									<?php }?>
									<div class="mt-2"></div>
									<?php if ($_smarty_tpl->tpl_vars['invoiceDetails']->value[0]['district_name']) {?>
                                     <div class="row">
											...
											<div class="col-lg-7 col-md-7 col-sm-7 col-7">
												   <h6 class="text-left"><small><?php echo $_smarty_tpl->tpl_vars['invoiceDetails']->value[0]['district_name'];?>
</small></h6>
											</div>
								    </div>
									<?php }?>
									<div class="mt-2"></div>
                                     <?php if ($_smarty_tpl->tpl_vars['invoiceDetails']->value[0]['panchayath_name']) {?>
									 <div class="row">
											...
											<div class="col-lg-7 col-md-7 col-sm-7 col-7">
												   <h6 class="text-left"><small><?php echo $_smarty_tpl->tpl_vars['invoiceDetails']->value[0]['panchayath_name'];?>
</small></h6>
											</div>
								    </div>
									<?php }?>
									<div class="mt-5"></div>
									<?php if ($_smarty_tpl->tpl_vars['invoiceDetails']->value[0]['public_key']) {?>
								    <div class="row">
											...
											<div class="col-lg-7 col-md-7 col-sm-7 col-7">
												   <h6 class="text-left"><small><?php echo $_smarty_tpl->tpl_vars['invoiceDetails']->value[0]['public_key'];?>
</small></h6>
											</div>
								    </div>
									<?php }?>
									<div class="mt-2"></div>
									<?php if ($_smarty_tpl->tpl_vars['invoiceDetails']->value[0]['amount']) {?>
								    <div class="row">
											...
											<div class="col-lg-7 col-md-7 col-sm-7 col-7">
												   <h6 class="text-left"><small><?php echo $_smarty_tpl->tpl_vars['invoiceDetails']->value[0]['amount'];?>
</small></h6>
											</div>
								    </div>
									<?php }?>
									<div class="mt-2"></div>
									<?php if ($_smarty_tpl->tpl_vars['invoiceDetails']->value[0]['created_on']) {?>
								    <div class="row">
											...
											<div class="col-lg-7 col-md-7 col-sm-7 col-7">
												   <h6 class="text-left"><small><?php echo $_smarty_tpl->tpl_vars['invoiceDetails']->value[0]['created_on'];?>
</small></h6>
											</div>
								    </div>
									<?php }?>
									<div class="mt-2"></div>
									<?php if ($_smarty_tpl->tpl_vars['invoiceDetails']->value[0]['expired_on']) {?>
									<div class="row">
									...
									<?php }?>
									<div class="mt-2"></div>
									<?php if ($_smarty_tpl->tpl_vars['invoiceDetails']->value[0]['description']) {?>
									<div class="row">
											...
											<div class="col-lg-7 col-md-7 col-sm-7 col-7">
												   <h6 class="text-left"><small><?php echo $_smarty_tpl->tpl_vars['invoiceDetails']->value[0]['description'];?>
</small></h6>
											</div>
								    </div>
									<?php }?>
												 ...
												 <form action="" method="POST">
													...
													<input type="hidden" name="key" value="invoiceKey">
													 ...
													 <input type="text" class="form-control form-control-sm" name="amount" value="<?php echo $_smarty_tpl->tpl_vars['invoiceDetails']->value[0]['amount'];?>
">
													 </div>
													 <div class="col-lg-4 col-sm-12 col-md-4 col-12" id="col-mt">
