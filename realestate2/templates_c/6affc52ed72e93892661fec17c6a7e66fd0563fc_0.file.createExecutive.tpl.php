<?php
/* Smarty version 3.1.36, created on 2022-12-20 09:34:22
  from '/home/u121402034/domains/a2zserver.in/public_html/REAL_ESTATE/project/view/createExecutive.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.36',
  'unifunc' => 'content_63a1819e650c99_97648569',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '6affc52ed72e93892661fec17c6a7e66fd0563fc' => 
    array (
      0 => '/home/u121402034/domains/a2zserver.in/public_html/REAL_ESTATE/project/view/createExecutive.tpl',
      1 => 1670311631,
      2 => 'file',
    ),
  ),
...
function content_63a1819e650c99_97648569 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
...
<section>
    <div class="container">
           ...
           <div class="row">
			...
			<h4 class="text-center">Executive Form</h4>
			</div>
		  </div>
                    ...
                    <div class="card">
						...
						<?php }?>		
                            ...
                            <form action="" method="post">
									<input type="hidden" name="act" value="addExecutive"/>
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                                            <label class="form-label  float-left">Executive Name</label>
                                        </div>
                                        <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                                            <input type="text" name="executivename" placeholder="Executive Name" class="form-control">
                                        </div>
                                    </div>
                                    <div class="mt-4"></div>
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                                            <label class="form-label  float-left">Executive Email id</label>
                                        </div>
                                        <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                                            <input type="text" name="executiveemail" placeholder="Executive Email" class="form-control">
                                        </div>
                                    </div>
                                    <div class="mt-4"></div>
                                    <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                                            <label class="form-label  float-left">Executive Contact number</label>
                                        </div>
                                        <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                                            <input type="text" name="executivephone" placeholder="contact number" placeholder="Executive Contact number" class="form-control">
                                        </div>
                                    </div>
                                    <div class="mt-4"></div>
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                                            <label class="form-label float-left">Executive District</label>
                                        </div>
                                        <div class="col-lg-6 col-md-6 col-sm-12 col-12">
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                                            <label class="form-label float-left">Executive Panchayath</label>
                                        </div>
                                        <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                                            <div class="float_right">
                                                <input type="submit" name="submit" value="Create Account" class="btn btn-danger btn-sm sm-btn">
                                            </div>
