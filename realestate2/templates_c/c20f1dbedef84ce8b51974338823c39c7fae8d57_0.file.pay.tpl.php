<?php
/* Smarty version 3.1.36, created on 2023-01-13 04:19:08
  from '/home/u121402034/domains/a2zserver.in/public_html/REAL_ESTATE/project/view/pay.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.36',
  'unifunc' => 'content_63c0dbbc54bd88_78120914',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'c20f1dbedef84ce8b51974338823c39c7fae8d57' => 
    array (
      0 => '/home/u121402034/domains/a2zserver.in/public_html/REAL_ESTATE/project/view/pay.tpl',
      1 => 1673583543,
      2 => 'file',
    ),
  ),
...
function content_63c0dbbc54bd88_78120914 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html lang="en">
<head>
    ...
    <div class="container">
        <div class="row" id="row">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-12">
					...
					<div class="card_1">
					     <div class="row">
						     <div class="col-lg-8 col-md-8 col-sm-8 col-8" style="font-size:14px;color:#000000;font-weight:bold;">
							       ONLINE PAYMENT
							 </div>
							 <div class="col-lg-4 col-md-4 col-sm-4 col-4">
							       <img src="img/payicon.png">
							 </div>
                            ...
                            <form action="" method="post" enctype="multipart/form-data">
									...
									<div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-12">
											...
											<img src="img/onlinepayment.png" class="img-fluid">
											
										   </div>
                                        </div>
										
										<div class="col-lg-12 col-md-12 col-sm-12 col-12 col-img-property">
                                           <div id="img-property" style="text-align:left;"> 
										   
											 <br> <strong style="font-size:14px;">PAY ONLINE :- </strong><br> 
											
											<div> <a style=" width: 200px; background-color: #1CA953; text-align: center; font-weight: 800; padding: 11px 0px; color: white; font-size: 12px; display: inline-block; text-decoration: none; " href='https://pmny.in/RrjlZ7ngRome' > Pay Now </a> </div>
										   </div>
                                        </div>
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-12 col-img-property">
                                           <div id="img-property" style="text-align:left;"> 
											 ...
											 <br> <strong style="font-size:14px;">PAY THROUGH BANK :- </strong><br> 
											 <div style="font-size:13px;">
											Account Name	: A2Z ALPHABETSOLUTIONZ PRIVATE LIMITED<br>  
											Account No.	: 323405000811<br>  
											IFSC Code	: ICIC0003234<br>  
											Swift.cod	: ICICINBBCTS<br>  
											e Branch	: Technopark Phase3<br>  
											 </div>
											
											<br> <strong style="font-size:14px;">PAY THROUGH  WHATS APP :- </strong><br> 
											 <div style="font-size:13px;">
											Number  	: 6282322567<br>  
