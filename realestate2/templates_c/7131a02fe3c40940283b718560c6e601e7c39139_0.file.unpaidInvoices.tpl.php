<?php
/* Smarty version 3.1.36, created on 2022-12-20 09:25:00
  from '/home/u121402034/domains/a2zserver.in/public_html/REAL_ESTATE/project/view/unpaidInvoices.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.36',
  'unifunc' => 'content_63a17f6c731306_58218926',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '7131a02fe3c40940283b718560c6e601e7c39139' => 
    array (
      0 => '/home/u121402034/domains/a2zserver.in/public_html/REAL_ESTATE/project/view/unpaidInvoices.tpl',
      1 => 1671347779,
      2 => 'file',
    ),
  ),
...
function content_63a17f6c731306_58218926 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html lang="en">
<head>
                ...
                <div class="row">
                    ...
                    <div style="margin-top: 30px;"></div>
                        <table class="table table-hover table-borderless table-responsive" id="table-id">
                            <thead>
                                <tr>
                                    <th class="text-center ">Invoice Key</th>
...
if ($_from !== null) foreach ($_from as $_smarty_tpl->tpl_vars['inv']->value) {
$_smarty_tpl->tpl_vars['inv']->do_else = false;
?>
                                <tr>
                                
                                    <td class="text-center font-weight-light"><?php echo $_smarty_tpl->tpl_vars['inv']->value['public_key'];?>
</td>
                                    <td class="text-center font-weight-light"> <?php echo $_smarty_tpl->tpl_vars['inv']->value['name'];?>
</td>
                                    <td class="text-center font-weight-light"> <?php echo $_smarty_tpl->tpl_vars['inv']->value['amount'];?>
</td>
									<td class="text-center font-weight-light"> <?php echo $_smarty_tpl->tpl_vars['inv']->value['created_on'];?>
</td>
									<td class="text-center font-weight-light"> <?php echo $_smarty_tpl->tpl_vars['inv']->value['expired_on'];?>
</td>		
									<td class="text-center font-weight-light">
									
										<a class="nav-link text-success btn" href="viewInvoice.php?key=<?php echo $_smarty_tpl->tpl_vars['inv']->value['invoice_key'];?>
">View Invoice</a>
							 ...
							 <?php } else { ?>
							 	 <div class="col-lg-12 col-md-12 col-sm-12 col-12">
									...
									<div class="box text-center">
										...
										<h6 class=" bg-light bg_light">There is no Unpaid Invoices yet</h6>
									</div>
