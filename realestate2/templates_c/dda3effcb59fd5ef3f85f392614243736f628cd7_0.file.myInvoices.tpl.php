<?php
/* Smarty version 3.1.36, created on 2022-12-21 09:55:29
  from '/home/u121402034/domains/a2zserver.in/public_html/REAL_ESTATE/project/view/myInvoices.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.36',
  'unifunc' => 'content_63a2d811ac0c07_49726056',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'dda3effcb59fd5ef3f85f392614243736f628cd7' => 
    array (
      0 => '/home/u121402034/domains/a2zserver.in/public_html/REAL_ESTATE/project/view/myInvoices.tpl',
      1 => 1671616524,
      2 => 'file',
    ),
  ),
...
function content_63a2d811ac0c07_49726056 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html lang="en">
<head>
                ...
                <div class="row">
                    ...
                    <div style="margin-top: 30px;"></div>
                        <table class="table table-hover table-borderless table-responsive" id="table-id">
                            ...
                            <tbody>
							<?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['invoices']->value, 'inv', false, 'k');
$_smarty_tpl->tpl_vars['inv']->do_else = true;
if ($_from !== null) foreach ($_from as $_smarty_tpl->tpl_vars['k']->value => $_smarty_tpl->tpl_vars['inv']->value) {
$_smarty_tpl->tpl_vars['inv']->do_else = false;
?>
                                <tr>
                                <form action="" method="POST">
								<input type="hidden" name="act" value="payment">
                                    <th class="text-center font-weight-light"><a href="viewInvoiceByAgent.php?k=<?php echo $_smarty_tpl->tpl_vars['inv']->value['invoice_key'];?>
"><?php echo $_smarty_tpl->tpl_vars['inv']->value['public_key'];?>
</a></th>
                                     <th class="text-center font-weight-light"> <?php echo $_smarty_tpl->tpl_vars['inv']->value['amount'];?>
</th>
                                     <th class="text-center font-weight-light"><?php echo $_smarty_tpl->tpl_vars['inv']->value['created_on'];?>
</th>
                                     <th class="text-center font-weight-light"><?php echo $_smarty_tpl->tpl_vars['inv']->value['expired_on'];?>
</th>
                                      <th class="text-center font-weight-light"><?php echo $_smarty_tpl->tpl_vars['inv']->value['description'];?>
</th>
									  
									  <input type="hidden" name="invoice_key" value="<?php echo $_smarty_tpl->tpl_vars['inv']->value['invoice_key'];?>
">
									  <input type="hidden" name="public_key" value="<?php echo $_smarty_tpl->tpl_vars['inv']->value['public_key'];?>
">
									  <input type="hidden" name="amount" value="<?php echo $_smarty_tpl->tpl_vars['inv']->value['amount'];?>
">
									  <input type="hidden" name="description" value="<?php echo $_smarty_tpl->tpl_vars['inv']->value['description'];?>
">
									  
									   <th class="text-center font-weight-light">
									   
											<div> <input type="submit" style=" width: 135px; background-color: #1CA953; text-align: center; font-weight: 800; padding: 5px 0px; color: white; font-size: 12px; display: inline-block; text-decoration: none;" value="Pay Now"></div>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>    
							 ...
							 <div class="col-lg-12 col-md-12 col-sm-12 col-12">
									...
									<div class="box text-center">
										...
										<h6 class=" bg-light bg_light">There is no Invoices Created Yet</h6>
									</div>
  ...
  <div class="container">
        ...
        <div class="row">  
               ...
               <div class="col-lg-3 col-md-3 col-sm-12 col-12 mt-3">
                   <h6>About Us</h6> 
                   <ul>
				        <li class="link"><a href="index.php">Home</li>
