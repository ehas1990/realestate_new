<?php
/* Smarty version 3.1.36, created on 2022-12-27 06:05:02
  from '/home/u121402034/domains/a2zserver.in/public_html/REAL_ESTATE/project/view/editPanchayath.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.36',
  'unifunc' => 'content_63aa8b0ed4fec7_64041610',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '6d5e96db8d2bd6c7f1110ac0f8ab9f2733c7e3d5' => 
    array (
      0 => '/home/u121402034/domains/a2zserver.in/public_html/REAL_ESTATE/project/view/editPanchayath.tpl',
      1 => 1670311167,
      2 => 'file',
    ),
  ),
...
function content_63aa8b0ed4fec7_64041610 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html lang="en">
<head>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                    ...
                    <div class="card">
						...
						<?php if ($_smarty_tpl->tpl_vars['displayMessage']->value == 1) {?> 
							...
							<?php }?>
						<?php }?>	
						<?php if ($_smarty_tpl->tpl_vars['panchayath']->value) {?>	
                            <form action="" method="post">
									<input type="hidden" name="act" value="editPanchayat">
									<input type="hidden" name="pkey" value="<?php echo $_smarty_tpl->tpl_vars['panchayath']->value['panchayath_key'];?>
">
									<div class="mt-4"></div>
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                                            <label class="form-label  float-left">Panchayat Name</label>
                                        </div>
                                        <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                                            <input type="text" name="panchayath" value="<?php echo $_smarty_tpl->tpl_vars['panchayath']->value['panchayath_name'];?>
" class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                                            <div class="float_right">
                                                <input type="submit" name="submit" value="Update Panchayat Name" class="btn btn-danger btn-sm sm-btn">
                                            </div>
						...
						<?php } else { ?>
							...
							Empty Panchayath Details.. Please contact Admin..
