<?php
/* Smarty version 3.1.36, created on 2022-12-21 09:21:51
  from '/home/u121402034/domains/a2zserver.in/public_html/REAL_ESTATE/project/view/listAgents.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.36',
  'unifunc' => 'content_63a2d02f2bd633_58787880',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'a5b0e0d0a372cf0a72791e9ef9b14269945e8692' => 
    array (
      0 => '/home/u121402034/domains/a2zserver.in/public_html/REAL_ESTATE/project/view/listAgents.tpl',
      1 => 1671614499,
      2 => 'file',
    ),
  ),
...
function content_63a2d02f2bd633_58787880 (Smarty_Internal_Template $_smarty_tpl) {
?><!DOCTYPE html>
<html lang="en">
<head>
                        ...
                        <table class="table table-hover table-borderless table-responsive" id="table-id">
                            <thead>
                                <tr>
									...
									<th class="text-center">In Active Properties</th>
...
?>
							...
							<?php if ($_smarty_tpl->tpl_vars['a']->value['user_type'] == '5') {?>
                                <tr>
                                
                                    <td class="text-center"><a href="agentProfile.php?key=<?php echo $_smarty_tpl->tpl_vars['a']->value['user_key'];?>
"><?php echo $_smarty_tpl->tpl_vars['a']->value['agent_name'];?>
</a></td>
                                    <td class="text-center"><?php echo $_smarty_tpl->tpl_vars['a']->value['district'];?>
 <br> [ <?php echo $_smarty_tpl->tpl_vars['a']->value['panchayath'];?>
 ]</td>
                                    <td class="text-center"><?php if ($_smarty_tpl->tpl_vars['a']->value['number_of_active_properties']) {
echo $_smarty_tpl->tpl_vars['a']->value['number_of_active_properties'];
} else { ?>0 Properties<?php }?></td>
									<td class="text-center"><?php if ($_smarty_tpl->tpl_vars['a']->value['number_of_inactive_properties']) {
echo $_smarty_tpl->tpl_vars['a']->value['number_of_inactive_properties'];
} else { ?>0 Properties<?php }?></td>
									<td class="text-center"><?php if ($_smarty_tpl->tpl_vars['a']->value['balance_amount'] > 0) {
echo $_smarty_tpl->tpl_vars['a']->value['balance_amount'];
}?></td>
									<td class="text-center">
									<ul class="nav justify-content-center">
                                                <li class="nav-item ">
                                                  <?php if ($_smarty_tpl->tpl_vars['a']->value['status'] == '0') {?>  <a class="nav-link text-success btn" href="activateAgent.php?key=<?php echo $_smarty_tpl->tpl_vars['a']->value['agent_key'];?>
" style="font-size:16px;">Activate</a><?php }?>
												  <?php if ($_smarty_tpl->tpl_vars['a']->value['status'] == '1') {?>  <a class="nav-link text-danger btn" href="deActivateAgent.php?key=<?php echo $_smarty_tpl->tpl_vars['a']->value['agent_key'];?>
" style="font-size:16px;">Deactivate</a><?php }?>
                                                </li>
                                    ...
                                    <td class="text-center">
                                        <a href="agentDetails.php?key=<?php echo $_smarty_tpl->tpl_vars['a']->value['user_key'];?>
"><img src="img/edit.png" alt="Edit" width="20" height="20"></a>
                                        
                                    </td>
									
									<td class="text-center font-weight-light">
										<?php if ($_smarty_tpl->tpl_vars['a']->value['readyToDelete'] == '0') {?> 
										<a href="deletActiveAgent.php?ukey=<?php echo $_smarty_tpl->tpl_vars['a']->value['user_key'];?>
&akey=<?php echo $_smarty_tpl->tpl_vars['a']->value['agent_key'];?>
" onclick="return confirm('Are you sure to Delete This Agent ?')" style="color:red;"><img src="img/deleteicon.png" alt="Delete" width="25" height="25"></a>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>  
							...
							<div class="col-lg-12 col-md-12 col-sm-12 col-12">
									...
									<div class="box text-center">
										...
										<h6 class=" bg-light bg_light">There is no agents listed in this platform yet..</h6>
									</div>
