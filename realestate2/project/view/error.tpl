									...
									<div class="row">
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-12 col-img-property">
                                           <div id="img-property" style="text-align:left;"> 
											 ...
											 Dear  Agent ,<br> <br>  Unexpected delay in payment from payment gateway.	
											Please try after some time.
											<br>If money deducted from your account , please send screenshots to :-  support@mediatorkerala.com, else whats app to :- +919961023238<br>
											<br>
											Regards,<br>
