                                ...
                                <tr>
									 ...
									 <td class="text-center">
                                        <ul class="nav justify-content-center">
                                                <li class="nav-item ">
                                                    ...
                                                    <a class="nav-link text-success btn" href="editPropertyByDistrictExecutive.php?key={$property.property_key}">Edit</a>
                                    ...
                                    <td class="text-center">
                                        <ul class="nav justify-content-center">
												...
												{else}
													<a class="nav-link text-danger btn" href="activatePropertyByAgent.php?key={$property.property_key}">Activate</a>
												{/if}
                                                </li>
