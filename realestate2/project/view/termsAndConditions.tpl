...
<html lang="en">
<head>
  <title>mediatorkerala | Terms And Conditions</title>
  <meta charset="utf-8">
...
<div class="mt-4"></div>
	  ...
	  <section>
	       <div class="container">
			       <div class="row">
				         <div class="col-lg-12  col-md-12 col-sm-12 col-12">
								  <h6 class="text-justify">OVERVIEW</h6>
								  <p>
									 This website is operated by Technopark Trivanduram. Throughout the site, the terms “we”, “us”
									 and “our” refer to Technopark Trivanduram.Technopark Trivanduramoffers this website,
	    ...
	    <section>
	       <div class="container">
			       ...
			       <div class="row">
				         <div class="col-lg-12  col-md-12 col-sm-12 col-12">
								  <h5 class="text-justify">SECTION 1 - ONLINE STORE TERMS</h5>
								  <p>
						   ...
						   <div class="col-lg-12  col-md-12 col-sm-12 col-12">
								  <h5 class="text-justify">SECTION 2 - GENERAL CONDITIONS</h5>
								  <p>
	       ...
	       <div class="container">
			       ...
			       <div class="row">
				         <div class="col-lg-12  col-md-12 col-sm-12 col-12">
								  <h5 class="text-justify">SECTION 3 - ACCURACY, COMPLETENESS AND TIMELINESS OF INFORMATION</h5>
								  <p>
				    ...
				    <div class="row">
				         <div class="col-lg-12  col-md-12 col-sm-12 col-12">
								  <h5 class="text-justify">SECTION 4 - MODIFICATIONS TO THE SERVICE AND PRICES</h5>
								  <p>
				    ...
				    <div class="row">
				         <div class="col-lg-12  col-md-12 col-sm-12 col-12">
								  <h5 class="text-justify">SECTION 5 - PRODUCTS OR SERVICES</h5>
								  <p>
							...
							<div class="col-lg-12  col-md-12 col-sm-12 col-12">
								  <h5 class="text-justify">SECTION 6 - ACCURACY OF BILLING AND ACCOUNT INFORMATION</h5>
								  <p>
							...
							<div class="col-lg-12  col-md-12 col-sm-12 col-12">
								  <h5 class="text-justify">SECTION 7 - OPTIONAL TOOLS</h5>
								  <p>
									  We reserve the right to refuse any order you place with us. We may, in our sole discretion, limit
										or cancel quantities purchased per person, per household or per order. These restrictions may
										include orders placed by or under the same customer account, the same credit card, and/or
							...
							<div class="col-lg-12  col-md-12 col-sm-12 col-12">
								  <h5 class="text-justify">SECTION 8 - THIRD-PARTY LINKS</h5>
								  <p>
							...
							<div class="col-lg-12  col-md-12 col-sm-12 col-12">
								  <h5 class="text-justify">SECTION 9 - USER COMMENTS, FEEDBACK AND OTHER SUBMISSIONS</h5>
								  <p>
							...
							<div class="col-lg-12  col-md-12 col-sm-12 col-12">
								  <h5 class="text-justify">SECTION 10 - PERSONAL INFORMATION</h5>
								  <p>
							...
							<div class="col-lg-12  col-md-12 col-sm-12 col-12">
								  <h5 class="text-justify">SECTION 11 - ERRORS, INACCURACIES AND OMISSIONS</h5>
								  <p>
							...
							<div class="col-lg-12  col-md-12 col-sm-12 col-12">
								  <h5 class="text-justify">SECTION 12 - PROHIBITED USES</h5>
								  <p>
							...
							<div class="col-lg-12  col-md-12 col-sm-12 col-12">
								  <h5 class="text-justify">SECTION 13 - DISCLAIMER OF WARRANTIES; LIMITATION OF LIABILITY</h5>
								  <p>
								  ...
								  <p>
								      In no case shall Techpark Trivanduram, our directors, officers, employees, affiliates, agents,
							...
							<div class="col-lg-12  col-md-12 col-sm-12 col-12">
								  <h5 class="text-justify">SECTION 14 - INDEMNIFICATION</h5>
								  <p>
									    You agree to indemnify, defend and hold harmless Technopark Trivanduram and our parent,
							...
							<div class="col-lg-12  col-md-12 col-sm-12 col-12">
								  <h5 class="text-justify">SECTION 15 - SEVERABILITY</h5>
								  <p>
							...
							<div class="col-lg-12  col-md-12 col-sm-12 col-12">
								  <h5 class="text-justify">SECTION 16 - TERMINATION</h5>
								  <p>
							...
							<div class="col-lg-12  col-md-12 col-sm-12 col-12">
								  <h5 class="text-justify">SECTION 17 - ENTIRE AGREEMENT</h5>
								  <p>
							...
							<div class="col-lg-12  col-md-12 col-sm-12 col-12">
								  <h5 class="text-justify">SECTION 18 - GOVERNING LAW</h5>
								  <p>
							...
							<div class="col-lg-12  col-md-12 col-sm-12 col-12">
								  <h5 class="text-justify">SECTION 19 - CHANGES TO TERMS OF SERVICE</h5>
								  <p>
								...
								<div class="col-lg-12  col-md-12 col-sm-12 col-12">
								  <h5 class="text-justify">SECTION 20 - CONTACT INFORMATION</h5>
								  <p>
									 Questions about the Terms of Service should be sent to us at <span class="font-weight-bold font-italic">support@mediatorkerala.com</span>
								  </p>
								  <p>
								        <img src="img/signature.png" class="float-right" height="60px">
								  </p>
