                        ...
                        <table class="table table-hover table-borderless table-responsive" id="table-id">
							...
							{foreach $agents as $a}
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><a href="agentProfile.php?key={$a.agent_key}">{$a.temp_name}</a></td>
									...
									<ul class="nav justify-content-center">
                                                <li class="nav-item ">
                                                  <a class="nav-link text-danger btn" href="activateNewAgentByExecutive.php?key={$a.temp_user_key}">Approve</a>
                                    ...
                                    <td class="text-center">
                                        <a href="pendingAgentDetailsForExecutive.php?key={$a.temp_user_key}">Edit</a>
                                        
                                    </td>
								
									
									   <th class="text-center font-weight-light"><a href="deletActiveAgent.php?ukey={$a.user_key}&akey={$a.agent_key}" onclick="return confirm('Are you sure to Delete This Agent ?')" style="color:red;">Delete</a></th>
