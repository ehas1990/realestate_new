                        ...
                        <table class="table table-hover table-borderless table-responsive" id="table-id">
							...
							{foreach $agents as $a}
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">{if $a.temp_name}{$a.temp_name}{else}Not Updated{/if}</td>
                                    <td class="text-center">{$a.district} [ {$a.panchayath} ]</td>
                                    <td class="text-center">{if $a.contact_number}{$a.contact_number}{else}Not Updated Yet{/if}</td>
									<td class="text-center">
										{if $a.temp_user_name}{$a.temp_user_name}{else}Not Updated Yet{/if}
									</td>
									<td class="text-center">
									<ul class="nav justify-content-center">
                                                <li class="nav-item ">
                                                  {if $a.temp_status=='0'}  <a class="nav-link text-danger btn" href="activateNewAgent.php?key={$a.temp_user_key}">Approve</a>{/if}
												  {if $a.temp_status=='1'}  <a class="nav-link text-success btn" href="deActivateNewAgent.php?key={$a.temp_user_key}">Reject</a>{/if}
                                                </li>
                                    ...
                                    <td class="text-center">
                                        <a href="pendingAgentDetails.php?key={$a.temp_user_key}"><img src="img/edit.png" alt="Edit" width="20" height="20"></a>
                                        
                                    </td>
									
									<th class="text-center font-weight-light"><a href="deletNewAgent.php?tkey={$a.temp_user_key}" onclick="return confirm('Are you sure to Delete {$a.temp_name} ?')" style="color:red;"><img src="img/deleteicon.png" alt="Delete" width="25" height="25"></a></th>
                                </tr>
