					     ...
					     <div class="row">
						     <div class="col-lg-6 col-md-6 col-sm-6 col-6">
							      <h6><!--  No.of Dealing :<span class="ml-2">3000 --></span>
								   <br>
								  {if $myBalance}	Balance Amount : {$myBalance}	{/if}
								  </h6>
							 </div>
							 <div class="col-lg-6 col-md-6 col-sm-6 col-6">
							       <h6> <img src="img/coin.png" width="20px" height="20px"><span class="ml-2">{if $points} {$points} {/if}</span><br> <a href="viewMyPoints.php">View Point History</a></h6>
							 </div>
                            ...
                            <form action="" method="post" enctype="multipart/form-data">
									...
									<div class="row">
                                        <div class="col-lg-6 col-md-6 col-sm-12 col-12">
											...
											<img src="cards/{$userKey}/{$recordDetails.record_key}/{$recordDetails.agent_photo_key}/{$recordDetails.agent_photo_name}" class="img-fluid">
										    {else}
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-12 col-12 col-img-property">
                                           <div id="img-property"> 
											...
											<img src="cards/{$userKey}/{$recordDetails.record_key}/{$recordDetails.agent_aadhar_key}/{$recordDetails.agent_aadhar_name}" class="img-fluid">
										    {else}
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                                            <input type="text" name="agentname" value="{$agentDetails.agent_name}" class="form-control" disabled>
                                        </div>
                                    </div>
                                    <div class="mt-4"></div>
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                                            <input type="text" name="username" {if $agentDetails.user_name} value="{$agentDetails.user_name}" {else}  placeholder="Email ID" {/if} class="form-control" disabled>
                                        </div>
                                    </div>
                                    <div class="mt-4"></div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                                            <input type="text" name="agentphone" {if $agentDetails.contact_number} value="{$agentDetails.contact_number}" {else}  placeholder="Contact Number" {/if} class="form-control" disabled>
                                        </div>
                                    </div>
                                    <div class="mt-4"></div>
									...
									<div class="row">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                                            <input type="text" name="agentphone" {if $agentDetails.district} value="{$agentDetails.district}" {else}  placeholder="Not Updated Yet" {/if} class="form-control" disabled>
                                        </div>
                                    </div>
									 <div class="mt-4"></div>
                                   <div class="row">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                                            <input type="text" name="agentphone" {if $agentDetails.panchayat} value="{$agentDetails.panchayat}" {else}  placeholder="Not Updated Yet" {/if} class="form-control" disabled>
                                        </div>
                                    </div>
