        ...
        <div class="container">
           ...
           <div class="row">
			<div class="col-lg-12 col-md-12 col-sm-12 col-12">
				...
				<h6 class="text-center">	Welcome <b>{$name}</b><br>
         ...
         <div class="row">
               ...
               <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                      <div class="form-card card">
							...
							<input type="hidden" name="property_key" value="{$details.property_key}"/>
							...
							<div class="row">
                                ...
                                <div class="row">
                                     ...
                                     <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                            <input type="text" name="clientname" value="{$details.Client_Name}" class="form-control">
								...
								<div class="row">
                                     ...
                                     <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                            <input type="text" name="clientnumber" value="{$details.Client_Number}" class="form-control">
                             ...
                             <div class="row">
                                ...
                                <div class="row">
                                     ...
                                     <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                            <input type="text" name="propertyname" value="{$details.property_name}" class="form-control">
                                ...
                                <div class="mt-4"></div>
								  ...
								  <div class="row">
                                     ...
                                     <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                         <span>  <input type="radio" name="propertyfor"  value="1" {if $details.property_for==1} checked {/if}> For Sale</span>
										 <span class="ml-3">    <input type="radio"  name="propertyfor" value="2" {if $details.property_for==2} checked {/if}> For Rent </span>
                               ...
                               <div class="row">
                                     ...
                                     <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                           <input type="text" name="propertyprice" value="{$details.property_price}" class="form-control">
                                     </div>
                             </div>
                             <div class="mt-4"></div>
                          <div class="row">
                               ...
                               <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                     <input type="text" name="propertyarea" value="{$details.property_area}" class="form-control">
                               </div>
                          </div>
                          <div class="mt-4"></div>
                         <!--  <div class="row">
                     ...
                     <!--  <div class="mt-4"></div>
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                            <div id="facilities">
                                                ...
                                                <select name="bedrooms" class="form-control ms-2" id="select_form-control">
                                                    <option {if $details.property_bedroom==1} selected {/if}>1</option>
                                                    <option {if $details.property_bedroom==2} selected {/if}>2</option>
                                                    <option {if $details.property_bedroom==3} selected {/if}>3</option>
													<option {if $details.property_bedroom==4} selected {/if}>4</option>
                                                    <option {if $details.property_bedroom==5} selected {/if}>5</option>
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                                <div id="facilities">
                                                    ...
                                                    <select name="bathrooms" class="form-control ms-2" id="select_form-control">
                                                        <option {if $details.property_bathroom==1} selected {/if}>1</option>
                                                        <option {if $details.property_bathroom==2} selected {/if}>2</option>
                                                        <option {if $details.property_bathroom==3} selected {/if}>3</option>
                                                        <option {if $details.property_bathroom==4} selected {/if}>4</option>
                                                        <option {if $details.property_bathroom==5} selected {/if}>5</option>
                                            ...
                                            <div id="facilities">
                                                    ...
                                                    <label class="form-label">Floor</label>
                                                        ...
                                                        <select name="floor" class="form-control ms-2" id="select_form_control">
                                                                <option {if $details.property_floor==1} selected {/if}>1</option>
                                                                <option {if $details.property_floor==2} selected {/if}>2</option>
                                                                <option {if $details.property_floor==3} selected {/if}>3</option>
                                                                <option {if $details.property_floor==4} selected {/if}>4</option>
                                                                <option {if $details.property_floor==5} selected {/if}>5</option>
                                                        </select>
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                                            <div id="facilities">
                                                ...
                                                <select name="parking" class="form-control ms-2" id="select_formcontrol">
                                                    <option {if $details.property_parking==1} selected {/if}>1</option>
                                                    <option {if $details.property_parking==2} selected {/if}>2</option>
                                                    <option {if $details.property_parking==3} selected {/if}>3</option>
                                                    <option {if $details.property_parking==4} selected {/if}>4</option>
                                                    <option {if $details.property_parking==5} selected {/if}>5</option>
                          ...
                          <div class="row">
                               ...
                               <div class="mt-2"></div>
                               <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                   <textarea name="description" cols="100px" class="form-control" maxlength="350">{$details.property_description}</textarea>
