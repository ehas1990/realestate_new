                        ...
                        <table class="table table-hover table-borderless table-responsive" id="table-id">
							...
							{if $a.user_type=='5'}
                                <tr>
                                    ...
                                    <td class="text-center"><a href="agentProfile.php?key={$a.user_key}">{$a.agent_name}</a></td>
                                    <td class="text-center">{$a.district} <br> [ {$a.panchayath} ]</td>
                                    <td class="text-center">{if $a.number_of_active_properties}{$a.number_of_active_properties}{else}0 Properties{/if}</td>
									<td class="text-center">{if $a.number_of_inactive_properties}{$a.number_of_inactive_properties}{else}0 Properties{/if}</td>
									<td class="text-center">{if $a.balance_amount>0}{$a.balance_amount}{/if}</td>
									<td class="text-center">
									<ul class="nav justify-content-center">
                                                <li class="nav-item ">
                                                  {if $a.status=='0'}  <a class="nav-link text-success btn" href="activateAgent.php?key={$a.agent_key}" style="font-size:16px;">Activate</a>{/if}
												  {if $a.status=='1'}  <a class="nav-link text-danger btn" href="deActivateAgent.php?key={$a.agent_key}" style="font-size:16px;">Deactivate</a>{/if}
                                                </li>
                                    ...
                                    <td class="text-center">
                                        <a href="agentDetails.php?key={$a.user_key}"><img src="img/edit.png" alt="Edit" width="20" height="20"></a>
                                        
                                    </td>
									
									<td class="text-center font-weight-light">
										{if $a.readyToDelete=='0'} 
										<a href="deletActiveAgent.php?ukey={$a.user_key}&akey={$a.agent_key}" onclick="return confirm('Are you sure to Delete This Agent ?')" style="color:red;"><img src="img/deleteicon.png" alt="Delete" width="25" height="25"></a>
