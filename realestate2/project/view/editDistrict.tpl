                    ...
                    <div class="card">
						...
						{/if}	
                            ...
                            <form action="" method="post">
									<input type="hidden" name="act" value="editDistrict">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                                            <input type="text" name="district" value="{$district_name}" class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                                            <div class="float-right">
                                                <input type="submit" name="submit" value="Update District" class="btn btn-danger btn-sm sm-btn">
                                            </div>
