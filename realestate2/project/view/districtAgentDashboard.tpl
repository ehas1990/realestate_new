					...
					<!--  
                     <div class="col-lg-3 col-md-3 col-sm-12 col-12">
                            <div class="box text-center">
                                ...
                                <h5><a href="agentsUnderDistrict.php?dKey={$districtKey}"  class="btn btn-light btn-dashboard">New Agents Waiting List in <br> {$district}</a></h5>
                            </div>
                     </div>
					  -->
                     ...
                     <div class="col-lg-3 col-md-3 col-sm-12 col-12">
                            <div class="box text-center">
                               <h5><a href="pendingPropertiesForDistrictExecutive.php"  class="btn btn-light btn-dashboard">List Pending Properties in <br> {$district}</a></h5>
                           </div>
                    </div>
                    
                     <div class="col-lg-3 col-md-3 col-sm-12 col-12">
                            <div class="box text-center">
                               <h5><a href="activePropertiesForDistrictExecutive.php"  class="btn btn-light btn-dashboard">List Active Properties in <br> {$district}</a></h5>
                           </div>
                    </div>
               </div>
        </div>
