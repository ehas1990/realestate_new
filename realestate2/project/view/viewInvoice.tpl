					...
					<div class="card_1">
					     <div class="row">
						     <div class="col-lg-9 col-md-9 col-sm-9 col-9" style="color:#000000;font-weight:bold;">
							       Invoice Details  : {$invoiceDetails.public_key}
							 </div>
						...
						<div class="col-12 col-lg-12 col-md-12 col-sm-12">
                            ...
                            <form action="" method="post" enctype="multipart/form-data">
									...
									<input type="hidden" name="invoice_key" value="{$invoiceDetails.invoice_key}">
									
									<div class="mt-4"></div>
									
									
									
									{if $invoiceDetails.agent_name}
									<div class="row">
											...
											<div class="col-lg-7 col-md-7 col-sm-7 col-7">
												   <h6 class="text-left"><small  > {$invoiceDetails.agent_name}</small></h6>
											</div>
								    </div>
									{/if}
									<div class="mt-2"></div>
								   {if $invoiceDetails.contact_number}	
                                   <div class="row">
											...
											<div class="col-lg-7 col-md-7 col-sm-7 col-7">
												   <h6 class="text-left"><small>{$invoiceDetails.contact_number}</small></h6>
											</div>
								    </div>
									{/if}
									<div class="mt-2"></div>
									{if $invoiceDetails.district_name}
                                     <div class="row">
											...
											<div class="col-lg-7 col-md-7 col-sm-7 col-7">
												   <h6 class="text-left"><small>{$invoiceDetails.district_name}</small></h6>
											</div>
								    </div>
									{/if}
									<div class="mt-2"></div>
                                     {if $invoiceDetails.panchayath_name}
									 <div class="row">
											...
											<div class="col-lg-7 col-md-7 col-sm-7 col-7">
												   <h6 class="text-left"><small>{$invoiceDetails.panchayath_name}</small></h6>
											</div>
								    </div>
									{/if}
									<div class="mt-5"></div>
									{if $invoiceDetails.public_key}
								    <div class="row">
											...
											<div class="col-lg-7 col-md-7 col-sm-7 col-7">
												   <h6 class="text-left"><small>{$invoiceDetails.public_key}</small></h6>
											</div>
								    </div>
									{/if}
									<div class="mt-2"></div>
								    ...
								    <div class="row">
											...
											<div class="col-lg-7 col-md-7 col-sm-7 col-7">
												   <h6 class="text-left"><small>{$invoiceDetails.amount}</small></h6>
											</div>
								    </div>
									{/if}
									<div class="mt-2"></div>
									{if $invoiceDetails.created_on}
								    <div class="row">
											...
											<div class="col-lg-7 col-md-7 col-sm-7 col-7">
												   <h6 class="text-left"><small>{$invoiceDetails.created_on}</small></h6>
											</div>
								    </div>
									{/if}
									<div class="mt-2"></div>
									{if $invoiceDetails.expired_on}
									<div class="row">
									...
									<div class="row">
											...
											<div class="col-lg-7 col-md-7 col-sm-7 col-7">
												   <h6 class="text-left"><small>{$invoiceDetails.description}</small></h6>
											</div>
								    </div>
									{/if}
									{if $invoiceDetails.amount}
									...
									<div class="row">
											...
											<div class="col-lg-12 col-md-12 col-sm-12 col-12">
													...
													<a href="deleteinvoice.php?key={$invoiceDetails.invoice_key}" style="border:1px solid #000000;padding:1px;color:red;font-size:10px;" onclick="confirmBeforeDelete()">DELETE THIS INVOICE</a>
