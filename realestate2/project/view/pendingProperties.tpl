                        ...
                        <table class="table table-hover table-borderless table-responsive" id="table-id">
							...
							{foreach from=$properties item=property}
                                <tr>
                                    ...
                                    <th class="text-center font-weight-light">{$property.name}</th>
                                     <th class="text-center font-weight-light"> {$property.district} <br> [ {$property.panchayath} ]</th>
                                    ...
                                    <td class="text-center">      
     								...
     								<ul class="nav justify-content-center">
                                                <li class="nav-item ">
                                                    <a class="nav-link text-success btn" href="activateProperty.php?key={$property.property_key}">Activate</a>
                                                </li>
									...
									<td class="text-center">      
     								...
     								<ul class="nav justify-content-center">
                                                <li class="nav-item ">
                                                    <a class="nav-link text-success btn" href="editPropertyByAdmin.php?key={$property.property_key}">Edit</a>
                                                </li>
                                    ...
                                    <td class="text-center">
                                        <ul class="nav justify-content-center">
                                                <li class="nav-item ">
                                                    <a href="deleteInActivePropertyByAdmin.php?key={$property.property_key}&u={$property.userkey}&return=inactive" onclick="return confirm('Are you sure to Delete This Property ?')" style="color:red;">Delete</a>
                                                </li>
