                        ...
                        <table class="table table-hover table-borderless table-responsive" id="table-id">
							...
							{foreach from=$invoices item=inv}
                                <tr>
                                    ...
                                    <td class="text-center font-weight-light">{$inv.public_key}</td>
                                    <td class="text-center font-weight-light"> {$inv.name}</td>
                                    <td class="text-center font-weight-light"> {$inv.amount}</td>
									<td class="text-center font-weight-light"> {$inv.created_on}</td>
									<td class="text-center font-weight-light"> {$inv.expired_on}</td>		
									<td class="text-center font-weight-light">
									
										<a class="nav-link text-success btn" href="viewInvoice.php?key={$inv.invoice_key}">View Invoice</a>
