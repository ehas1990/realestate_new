                            ...
                            <form action="" method="post">
									...
									<div class="row">
                                        <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                                            <div id="img-property"> 
											{if $agentRecords}
												{if $agentRecords.agent_photo_name}
													<img src="cards/{$agentDetails.user_key}/{$agentRecords.record_key}/{$agentRecords.agent_photo_key}/{$agentRecords.agent_photo_name}" class="img-fluid">
												{else}
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                                           <div id="img-property"> 
												{if $agentRecords}
													{if $agentRecords.agent_aadhar_name}
														<img src="cards/{$agentDetails.user_key}/{$agentRecords.record_key}/{$agentRecords.agent_aadhar_key}/{$agentRecords.agent_aadhar_name}" class="img-fluid">
													{else}
