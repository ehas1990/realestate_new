						...
						{/if}
                            ...
                            <form action="" method="post"  enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                                            <input type="text" name="agentname" value="{$agentDetails.temp_name}" class="form-control">
                                        </div>
                                    </div>
                                    <div class="mt-4"></div>
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-12 col-12">
                                            <input type="text" name="username" {if $agentDetails.temp_user_name} value="{$agentDetails.temp_user_name}" {else}  placeholder="Email ID" {/if} class="form-control">
                                        </div>
                                    </div>
                                    <div class="mt-4"></div>
                                    <div class="row">
