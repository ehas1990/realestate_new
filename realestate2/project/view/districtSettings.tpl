						...
						{if $districts}	
							<table class="table table-hover table-borderless table-responsive" id="table-id">
								...
								{foreach from=$districts item=d}
									...
									<tr>
										<td class="text-center">{$d.district_name}</a></td>
										<td class="text-center"><a href="editDistrict.php?key={$d.district_key}">Edit </a></td>
										{if $d.popular==0}
										<td class="text-center"><a href="markPopularDistrict.php?key={$d.district_key}">Mark us Popular </a></td>
										{else if $d.popular==1}
										<td class="text-center"><a href="markNormalDistrict.php?key={$d.district_key}">Mark us Normal </a></td>
										{/if}
									</tr>
