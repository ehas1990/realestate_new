                ...
                <div class="row">
                    ...
                    <div style="margin-top: 30px;"></div>
                        <table class="table table-hover table-borderless table-responsive" id="table-id">
							...
							{if $invoices}
                            <tbody>
							{foreach from=$invoices key=k item=inv}
                                <tr>
                                <form action="" method="POST">
								<input type="hidden" name="act" value="payment">
                                    <th class="text-center font-weight-light"><a href="viewInvoiceByAgent.php?k={$inv.invoice_key}">{$inv.public_key}</a></th>
                                     <th class="text-center font-weight-light"> {$inv.amount}</th>
                                     <th class="text-center font-weight-light">{$inv.created_on}</th>
                                     <th class="text-center font-weight-light">{$inv.expired_on}</th>
                                      <th class="text-center font-weight-light">{$inv.description}</th>
									  
									  <input type="hidden" name="invoice_key" value="{$inv.invoice_key}">
									  <input type="hidden" name="public_key" value="{$inv.public_key}">
									  <input type="hidden" name="amount" value="{$inv.amount}">
									  <input type="hidden" name="description" value="{$inv.description}">
